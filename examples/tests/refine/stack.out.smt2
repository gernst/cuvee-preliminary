...
(assert (forall ((head1 Elem) (tail2 Lst) (size Int) (values (Array Int Elem))) (= (R (cons head1 tail2) size values) (and (and (< 0 size) (= head1 (select values (- size 1)))) (R tail2 (- size 1) values)))))
(assert (forall ((size Int) (values (Array Int Elem))) (= (R nil size values) (= 0 size))))
(assert (not (and (and (forall ((xs Lst) (size Int) (values (Array Int Elem))) (=> (and (and true true) true) (and true (and true (R nil 0 values))))) (forall ((xs Lst) (x Elem) (size Int) (values (Array Int Elem)) (|x'| Elem)) (=> (and (and (= x |x'|) true) (R xs size values)) (and true (and true (R (cons x xs) (+ size 1) (store values size |x'|))))))) (forall ((xs Lst) (x Elem) (size Int) (values (Array Int Elem)) (|x'| Elem)) (=> (and (and true (distinct xs nil)) (R xs size values)) (and (> size 0) (and (= (head xs) (select values (- size 1))) (R (tail xs) (- size 1) values))))))))
(check-sat)
(pop 1)
(pop 1)
(push 1)
