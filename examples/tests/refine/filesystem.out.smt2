...
(assert (not (and (forall ((fs (Array Name File)) (index (Array Name Address)) (disk (Array Address File))) (=> (and true true) (R fs0 index0 (store disk null empty)))) (forall ((fs (Array Name File)) (name Name) (file File) (index (Array Name Address)) (disk (Array Address File)) (|name'| Name) (|file'| File)) (=> (= name |name'|) (=> (and (distinct (select fs name) empty) (R fs index disk)) (and (distinct (select index |name'|) null) (and (= (select fs name) (select disk (select index |name'|))) (R fs index disk)))))) (forall ((fs (Array Name File)) (name Name) (file File) (index (Array Name Address)) (disk (Array Address File)) (|name'| Name) (|file'| File)) (=> (and (= name |name'|) (= file |file'|)) (=> (and (distinct (select fs name) empty) (R fs index disk)) (and (distinct (select index |name'|) null) (forall ((addr Address)) (and true (=> (exists ((addr Address)) (and (distinct addr null) (= (select disk addr) empty))) (and (exists ((addr2 Address)) (and (distinct addr2 null) (= (select disk addr2) empty))) (forall ((addr2 Address)) (=> (and (distinct addr2 null) (= (select disk addr2) empty)) (and true (R (store fs name file) (store index |name'| addr2) (store disk addr2 |file'|))))))))))))))))
(check-sat)
(pop 1)
(pop 1)
